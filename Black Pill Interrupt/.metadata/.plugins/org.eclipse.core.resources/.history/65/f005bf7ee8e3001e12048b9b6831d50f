...
int PWMPulse = 50, PSC_Constante = 0;
uint32_t WantedRPM = 0, NewRPM = 0, CurrentRPM = 0;
double sintab[AANTAL_TIJDSTAPPEN];
...
int main(void)
{
  ...
  */
  ...
  while (1)
  {
	...
	TIM4->PSC = (15 * Fapb1clk) / (256 * WantedRPM) - 1;
